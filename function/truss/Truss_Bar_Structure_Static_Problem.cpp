 ...
 *
 *  Modify on: 18/05/2012 based in file Truss_Bar_Structure_Static_Problem.cpp
 *      Author: Eduardo Krempser
 */

/*
 * File:   Truss_Bar_Structure_Static_Problem.cpp
...
Truss_Bar_Structure_Static_Problem::Truss_Bar_Structure_Static_Problem(int dimension, void* bounds, int maxNumberObjectiveFunctionEvaluations, int numberObjectives, int numberConstraints, int numberOfBars, double gamma, double stressConstraint, double displacementConstraint, /*int numberOfDisplacementConstraints,*/ string inputFileName, double lowerBound, double upperBound): Problem(dimension, bounds, maxNumberObjectiveFunctionEvaluations, numberObjectives, numberConstraints), numberOfBars(numberOfBars), gamma(gamma), stressConstraint(stressConstraint), displacementConstraint(displacementConstraint)/*, numberOfDisplacementConstraints(numberOfDisplacementConstraints)*/, areasAux(new double[ this->numberOfBars ]), numberOfDisplacements(-1) {
	...
	this->simulator = Truss_Bar_Structure_Static_Simulator_Ptr(
		new Truss_Bar_Structure_Static_Simulator(
...
Truss_Bar_Structure_Static_Problem::Truss_Bar_Structure_Static_Problem(const Truss_Bar_Structure_Static_Problem& orig): Problem(orig), areasAux(new double[ this->numberOfBars ]), numberOfDisplacements(-1) {
...
void Truss_Bar_Structure_Static_Problem::evaluation(void* vector, void* values) {
...
void Truss_Bar_Structure_Static_Problem::fillAreasAux(double* x) {
...
int Truss_Bar_Structure_Static_Problem::getNumberOfDisplacements() {
...
void Truss_Bar_Structure_Static_Problem::readFile(string fileName) {
...
int const Truss_Bar_Structure_Static_Problem::getNumberOfBars() {
	return this->numberOfBars;
}

int* const Truss_Bar_Structure_Static_Problem::getGrouping() {
	return NULL;
}

double* const Truss_Bar_Structure_Static_Problem::getAreasAux() {
	return this->areasAux;
}

int const Truss_Bar_Structure_Static_Problem::getNLCase() {
	return this->nlcase_cpp;
}

double const Truss_Bar_Structure_Static_Problem::getDisplacementConstraint() {
	return this->displacementConstraint;
}

double* const Truss_Bar_Structure_Static_Problem::getStressDisplacementAux() {
	return this->stressDisplacementAux;
}

Truss_Bar_Structure_Static_Simulator_Ptr const Truss_Bar_Structure_Static_Problem::getSimulator() {
