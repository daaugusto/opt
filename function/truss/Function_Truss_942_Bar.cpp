...
Function_Truss_942_Bar::Function_Truss_942_Bar(): Truss_Bar_Structure_Static_Problem(59, NULL, 150000, 1, 954/*696+942?*/, 942, 0.1, 25000, 15, "input942.dat", 1, 200), grouping(NULL) {
}

Function_Truss_942_Bar::Function_Truss_942_Bar(const Function_Truss_942_Bar& orig): Truss_Bar_Structure_Static_Problem(orig), grouping(NULL){
}

Function_Truss_942_Bar::~Function_Truss_942_Bar() {
    delete[] this->grouping;
}

int* const Function_Truss_942_Bar::getGrouping () {
	...
	void Function_Truss_942_Bar::fillAreasAux(double* x) {
