/*
 * Truss_Bar_Structure_Static_Simulator.cpp
 *
 *  Modify on: 18/05/2012 based in file Truss_Bar_Structure_Static_Simulator.h
 *      Author: Eduardo Krempser
 */

/*
 * File:   Truss_Bar_Structure_Static_Simulator.h
...
#include "Truss_Bar_Structure_Static_Simulator.h"
...
//		double** ielmnt;
	...
	Truss_Bar_Structure_Static_Simulator::~Truss_Bar_Structure_Static_Simulator() {
		delete[] this->memory;
		delete[] this->npar;
	 ...
	 */
	int Truss_Bar_Structure_Static_Simulator::tensoes(double *tens1, double *tens2, double *tens3, int *l, double *tens) {
		int i__;
	 ...
	 */
	int Truss_Bar_Structure_Static_Simulator::desloc(double *d1, double *d2, double * d3, int *l, double *desl, int n_desloc_cpp) {
		int i__;
	 ...
	 */
	int Truss_Bar_Structure_Static_Simulator::endarea(double *area, int *nume, double * param) {
	...
	/* Method colht.
	 */
	int Truss_Bar_Structure_Static_Simulator::colht(int *mht, int *nd, int *lm) {
	...
	/* Method addban.
	 */
	int Truss_Bar_Structure_Static_Simulator::addban(double *a, int *maxa, double *s, int *lm, int *nd) {
		/* System generated locals */
		int i__1;
		int i__2;
	...
	/* Method russ.
	 */
	int Truss_Bar_Structure_Static_Simulator::russ(int *id, double *x, double *y, double *z__, double *u, int *mht, double *e, double *area, int *lm, double *xyz, int *matp, double *tens, int *ncar) {
	...
	/* Method error.
	 */
	int Truss_Bar_Structure_Static_Simulator::error(int *n, int *i__) {
	...
	/* Method truss.
	 */
	int Truss_Bar_Structure_Static_Simulator::truss(double *param, int *ncar) {
		/* System generated locals */
		int i__1;
	...
	/* Method elemnt.
	 */
	int Truss_Bar_Structure_Static_Simulator::elemnt(double *param, int *ncar) {
		int npar1;
	...
	/* Method stress.
	 */
	int Truss_Bar_Structure_Static_Simulator::stress(double *aa, double *param, int *ncar) {
		/* System generated locals */
		int i__1;
		int i__2;
	...
	/* Method writed.
	 */
	int Truss_Bar_Structure_Static_Simulator::writed(double *disp, int *id, int *neq, int *numnp) {
		/* System generated locals */
		int i__1;
	...
	/* Method loadv.
	 */
	int Truss_Bar_Structure_Static_Simulator::loadv(double *r__, int *neq) {
		/* System generated locals */
		int r_dim1;
	...
	/* Method colsol.
	 */
	int Truss_Bar_Structure_Static_Simulator::colsol(double *a, double *v, int *maxa, int *nn, int *nwk, int *nnm, int *kkk) {
	...
	/* Method assem.
	 */
	int Truss_Bar_Structure_Static_Simulator::assem(double *aa, double *param, int *ncar) {
		/* System generated locals */
		int i__1;
		int i__2;
	...
	/* Method clear.
	 */
	int Truss_Bar_Structure_Static_Simulator::clear(double *a, int *n) {
		/* System generated locals */
		int i__1;
	...
	/* Method addres.
	 */
	int Truss_Bar_Structure_Static_Simulator::addres(int *maxa, int *mht) {
		/* System generated locals */
		int i__1;
	...
	/* Method elcal.
	 */
	int Truss_Bar_Structure_Static_Simulator::elcal(double *param, int *ncar) {
	...
	/* Method loads.
	 */
	int Truss_Bar_Structure_Static_Simulator::loads(double *r__, int *nod, int *idirn, double *fload, int *id, int *nload, int *neq, int loadCase) {
	...
	/* Method input.
	 */
	int Truss_Bar_Structure_Static_Simulator::input(int *id, double *x, double *y, double *z__, int *numnp, int *neq) {
	...
	/* Method calcfobj.
	 */
	int Truss_Bar_Structure_Static_Simulator::calcfobj(double *u, double *tens, double *xyz, double *area, int *nume, double *param, double *fobj, double *v, double *d1, double * d2, double *d3, double *tens1, double *tens2, double * tens3, int n_constraints_cpp, int nlcase) {
	...
	/* Method stap.
	 */
	double Truss_Bar_Structure_Static_Simulator::stap(double *param, double *fobj, double *v) {
		/* System generated locals */
		int i__1;
		int i__2;
		double ret_val;
