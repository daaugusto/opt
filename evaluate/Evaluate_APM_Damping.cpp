/*
 * EvaluateAPMDamping.cpp
 *
 *  Created on: 08/02/2012
 *      Author: krempser
 */

#include "Evaluate_APM_Damping.h"

namespace opt {
namespace evaluate {

	//Update weigths of constraints
	void Evaluate_APM_Damping::update(vector<IndividualPtr> pop){
