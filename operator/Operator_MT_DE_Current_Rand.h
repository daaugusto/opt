/*
 * Operator_MT_DE_Current_Rand.h
 *
 *  Created on: 09/02/2012
 *      Author: krempser
 */

#ifndef OPERATOR_MT_DE_CURRENT_RAND_H_
#define OPERATOR_MT_DE_CURRENT_RAND_H_
...
namespace operators {
	...
	class Operator_MT_DE_Current_Rand: public Operator {
		public:
			Operator_MT_DE_Current_Rand();
...
#endif /* OPERATOR_MT_DE_CURRENT_RAND_H_ */
