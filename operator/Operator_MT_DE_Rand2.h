/*
 * Operator_MT_DE_Rand2.h
 *
 *  Created on: 09/02/2012
 *      Author: krempser
 */

#ifndef OPERATOR_MT_DE_RAND2_H_
#define OPERATOR_MT_DE_RAND2_H_
...
namespace operators {
	...
	class Operator_MT_DE_Rand2: public opt::operators::Operator {
		public:
			Operator_MT_DE_Rand2();
